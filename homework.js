...
// console log your variable fruit 
let fruit = "banana" 
console.log (fruit);
fruit = "peach"
console.log (fruit);
...
function product (numberset){
    console.log (product) 
    return product * numberset   
}
function numberset (numberset){
    product.call (4&689);
    this.category = 4&689;
}
...
//function five (name:any); {
     console.log (five: any )
    var five = function (name) {
        console.log("pineapple," + "five " + name);
        greeting ("pineapple")
        };
}
//Problem 5
...
function shortwords ([words, then]){
   return newArray
    }
